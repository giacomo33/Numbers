...
namespace Sum
{
    public static class ExtendedEnumerableRange
    {
        public static IEnumerable<sbyte> SByte(sbyte from, sbyte to, int step)
        {
            return ExtendedEnumerableRange.Int32(from, to, step).Select(i => (sbyte)i);
        }
        ...
        {
            return ExtendedEnumerableRange.Int32(from, to, step).Select(i => (short)i);
        }
        ...
        public static bool SequenceEqual(this IEnumerable<long> first, IEnumerable<long> second)
        {
